...
<body>
  ...
  <main>
    <div class="content">
      ...
      <div class="row">
        <div class="col-right">
          <a href="view_admin.php" class="adminbutton"><i class='bx bxs-user-account'></i> View Admins</a>
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href='edit_user.php?id=<?= $row['userID'] ?>' class='editbutton'><i class='bx bx-edit'></i></a>
